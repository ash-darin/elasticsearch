...
public class EsqlBaseParser extends ParserConfig {
  ...
  public final RandomSampleCommandContext randomSampleCommand() throws RecognitionException {
    ...
    try {
      ...
      setState(514);
      ((RandomSampleCommandContext)_localctx).probability = match(DECIMAL_LITERAL);
      setState(516);
      _errHandler.sync(this);
      ...
      case 1:
        {
        setState(515);
        ((RandomSampleCommandContext)_localctx).seed = match(INTEGER_LITERAL);
        }
        break;
      }
      }
